...
- 생성 시각: `2026-08-13T13:15:48.374485+00:00`
- 평가 split: `test`
- 샘플 수: `126`
...
| 평균 지연시간 (ms) | 122.73 | 2409.79 | 466.05 |
| P50 지연시간 (ms) | 31.07 | 3075.03 | 32.64 |
| P95 지연시간 (ms) | 45.37 | 3771.05 | 3218.90 |
...
- Claude-only 대비 평균 지연시간 감소율: `80.66%`
- Claude-only 대비 P95 지연시간 감소율: `14.64%`
...
| Average latency reduction | > 0% | 0.8066 | 충족 |
| P95 latency reduction | > 0% | 0.1464 | 충족 |
