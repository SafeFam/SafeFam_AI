...
class ScoreOutput:
    ...
    def __post_init__(self) -> None:
        ...
        # frozen dataclass이므로 object.__setattr__을 사용하여
        # np.ndarray로 변환된 값을 self.values에 확실하게 저장
...
class BasePhishingClassifier(ABC):
    ...
    def labels_from_scores(
        ...
        *,
        ...
        """이미 계산한 score를 label로 변환해 test 중복 추론을 피함"""
    ...
    def predict(
        ...
        *,
        ...
        """기본 또는 지정 threshold를 적용해 label을 반환"""
