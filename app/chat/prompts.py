...
SYSTEM_PROMPT_NO_CONTEXT = """당신은 SafeFam 스미싱 탐지 서비스에 내장된 한국어 금융사기 대응 상담사 '세이프챗'입니다.
사용자가 피싱 및 금융사기 관련 질문을 하고 있습니다.
...
def build_system_prompt(analysis_context: AnalysisContext | None) -> str:
